// Maps a merchant category to a clean line icon (no emoji).
// Returns null for 'Other'/unknown so the caller can fall back to a letter.
...
export function hasCategoryIcon(category?: string | null): boolean {
  return !!category && category in ICONS
}

export default function CategoryIcon({ category, size = 20 }: { category?: string | null; size?: number }) {
  const paths = category ? ICONS[category] : null
